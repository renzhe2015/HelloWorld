...
public abstract class AsyncHttpResponseHandler implements ResponseHandlerInterface {
            ...
            switch (message.what) {
                case SUCCESS_MESSAGE:
                    ...
                    if (response != null && response.length >= 3) {
                        ...
                        if(handlerListener!=null) {
                            handlerListener.onSuccess((Integer) response[0], (Header[]) response[1], (byte[]) response[2]);
                        }
                    } else {
                ...
                case FAILURE_MESSAGE:
                    ...
                    if (response != null && response.length >= 4) {
                        ...
                        if(handlerListener!=null) {
                            handlerListener.onFailure((Integer) response[0], (Header[]) response[1], (byte[]) response[2], (Throwable) response[3]);
                        }
                    } else {
    ...
    @Override
    public ResponseHandlerInterface setHandlerListener(HandlerListener handlerListener) {
